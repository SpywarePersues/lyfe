    ...
    return(
        <div className='bg-black bg-opacity-70 w-full p-5 absolute flex justify-between'>
            ...
            <ul className='flex text-xl text-gray-100 justify-between'>
                {token ? (<div><Link href={'/appointment'}><li className='text-teal-400 hover:text-gray-100 cursor-pointer hover:bg-teal-300 px-3 py-4 text-bold hover:ease-in-out duration-200 rounded-sm'>Appointment</li></Link></div>) : (<div></div>)}

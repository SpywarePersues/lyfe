...
const Otolaryngologists = () => {
    ...
    return (
        <div>
            <Head>
                <title>Lyfe | Otolaryngologists</title>
            </Head>
            <Navbar />
            <h1 className='text-4xl ml-[38rem] pt-[8rem] underline'>Otolaryngologists</h1>
            <p className='w-[45rem] text-center text-2xl ml-[24.5rem] mt-6'>They treat diseases in the ears, nose, throat, sinuses, head, neck, and respiratory system. They also can do reconstructive and plastic surgery on your head and neck.</p>
            <div className="px-6 pt-4 pb-2 ml-[37rem]">
                <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-blue-500 mr-2 mb-2"><Link href='https://meet.google.com/cih-zzyw-cqt'>https://meet.google.com/cih-zzyw-cqt</Link></span>
            </div>
...
export default Otolaryngologists
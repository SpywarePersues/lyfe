    ...
    return (
        <div>
            ...
            <div className="px-6 pt-4 pb-2 ml-[37rem]">
                <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-blue-500 mr-2 mb-2"><Link href='https://meet.google.com/oja-hfhc-byi'>https://meet.google.com/oja-hfhc-byi</Link></span>
            </div>

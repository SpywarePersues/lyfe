...
const Radiologists = () => {
    ...
    return (
        <div>
            <Head>
                <title>Lyfe | Radiologists</title>
            </Head>
            <Navbar />
            <h1 className='text-4xl ml-[40rem] pt-[8rem] underline'>Radiologists</h1>
            <p className='w-[45rem] text-center text-2xl ml-[24.5rem] mt-6'>They use X-rays, ultrasound, and other imaging tests to diagnose diseases. They can also specialize in radiation oncology to treat conditions like cancer.</p>
            <div className="px-6 pt-4 pb-2 ml-[37rem]">
                <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-blue-500 mr-2 mb-2"><Link href='https://meet.google.com/ysz-gpeo-piq'>https://meet.google.com/ysz-gpeo-piq</Link></span>
            </div>

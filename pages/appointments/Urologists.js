...
const Urologists = () => {
    ...
    return (
        <div>
            <Head>
                <title>Lyfe | Urologists</title>
            </Head>
            <Navbar />
            <h1 className='text-4xl ml-[41rem] pt-[8rem] underline'>Urologists</h1>
            <p className='w-[45rem] text-center text-2xl ml-[24.5rem] mt-6'>These are surgeons who care for men and women for problems in the urinary tract, like a leaky bladder. They also treat male infertility and do prostate exams.</p>
            <div className="px-6 pt-4 pb-2 ml-[37rem]">
                <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-blue-500 mr-2 mb-2"><Link href='https://meet.google.com/sqs-jsja-nmv'>https://meet.google.com/sqs-jsja-nmv</Link></span>
            </div>

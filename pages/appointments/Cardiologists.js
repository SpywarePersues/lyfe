...
const Cardiologists = () => {
    ...
    return (
        <div>
            <Head>
                <title>Lyfe | Cardiologists</title>
            </Head>
            <Navbar />
            <h1 className='text-4xl ml-[40.5rem] pt-[8rem] underline'>Cardiologists</h1>
            <p className='w-[45rem] text-center text-2xl ml-[24.5rem] mt-6'>They’re experts on the heart and blood vessels. You might see them for heart failure, a heart attack, high blood pressure, or an irregular heartbeat.</p>
            <div className="px-6 pt-4 pb-2 ml-[37rem]">
                <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-blue-500 mr-2 mb-2"><Link href='https://meet.google.com/qpq-uxuc-miz'>https://meet.google.com/qpq-uxuc-miz</Link></span>
            </div>

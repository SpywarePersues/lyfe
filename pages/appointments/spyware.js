...
const Spyware = () => {
    ...
    return (
        ...
        <div className='py-32 font-Finlandica h-[95vh]'>
            <Head>
                <title>Lyfe | Spyware</title>
            </Head>`
            <h1 className='text-3xl text-center font-bold'>Dr. SpywarePerseus Ghosh</h1>
            <p className='text-base text-center font-bold'>Neurologist</p>

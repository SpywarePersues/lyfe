...
const Rheumatologists = () => {
    ...
    return (
        <div>
            <Head>
                <title>Lyfe | Rheumatologists</title>
            </Head>
            <Navbar />
            <h1 className='text-4xl ml-[38rem] pt-[8rem] underline'>Rheumatologists</h1>
            <p className='w-[45rem] text-center text-2xl ml-[24.5rem] mt-6'>They specialize in arthritis and other diseases in your joints, muscles, bones, and tendons. You might see them for your osteoporosis (weak bones), back pain, gout, tendinitis from sports or repetitive injuries, and fibromyalgia.</p>
            <div className="px-6 pt-4 pb-2 ml-[37rem]">
                <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-blue-500 mr-2 mb-2"><Link href='https://meet.google.com/qbr-wgmr-ioy'>https://meet.google.com/qbr-wgmr-ioy</Link></span>
            </div>
...
export default Rheumatologists
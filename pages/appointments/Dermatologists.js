...
const Dermatologists = () => {
    ...
    return (
        <div>
            <Head>
                <title>Lyfe | Dermatologists</title>
            </Head>
            <Navbar />
            <h1 className='text-4xl ml-[40rem] pt-[8rem] underline'>Dermatologists</h1>
            <p className='w-[45rem] text-center text-2xl ml-[24.5rem] mt-6'>Have problems with your skin, hair, nails? Do you have moles, scars, acne, or skin allergies? Dermatologists can help.</p>
            <div className="px-6 pt-4 pb-2 ml-[37rem]">
                <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-blue-500 mr-2 mb-2"><Link href='https://meet.google.com/prd-sqat-afs'>https://meet.google.com/prd-sqat-afs</Link></span>
            </div>

...
const Ophthalmologists = () => {
    ...
    return (
        <div>
            <Head>
                <title>Lyfe | Ophthalmologists</title>
            </Head>
            <Navbar />
            <h1 className='text-4xl ml-[38rem] pt-[8rem] underline'>Ophthalmologists</h1>
            <p className='w-[45rem] text-center text-2xl ml-[24.5rem] mt-6'>You call them eye doctors. They can prescribe glasses or contact lenses and diagnose and treat diseases like glaucoma. Unlike optometrists, they’re medical doctors who can treat every kind of eye condition as well as operate on the eyes.</p>
            <div className="px-6 pt-4 pb-2 ml-[37rem]">
                <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-blue-500 mr-2 mb-2"><Link href='https://meet.google.com/orf-vrqw-jyo'>https://meet.google.com/orf-vrqw-jyo</Link></span>
            </div>

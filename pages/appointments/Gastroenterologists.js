...
const Gastroenterologists = () => {
    ...
    return (
        <div>
            <Head>
                <title>Lyfe | Gastroenterologists</title>
            </Head>
            <Navbar />
            <h1 className='text-4xl ml-[38rem] pt-[8rem] underline'>Gastroenterologists</h1>
            <p className='w-[45rem] text-center text-2xl ml-[24.5rem] mt-6'>They’re specialists in digestive organs, including the stomach, bowels, pancreas, liver, and gallbladder. You might see them for abdominal pain, ulcers, diarrhea, jaundice, or cancers in your digestive organs. They also do a colonoscopy and other tests for colon cancer</p>
